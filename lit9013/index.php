...
require_once("./lit9013_inclusions.php");
...
<HTML>
	<HEAD>
		<title>LiT 9013 - <?php echo $oPage->page_title; ?></title>
		...
		<link rel="stylesheet" type="text/css" href="css/lit9013/pbf_amb.css">
		<link rel="stylesheet" type="text/css" href="css/lit9013/pbf_style.css">
		<link rel="stylesheet" type="text/css" href="css/lit9013/pbf_site.css">
		<link rel="stylesheet" type="text/css" href="css/lit9013/pbf_multimenuvert_new.css">
		<link rel="stylesheet" type="text/css" href="css/lit9013/noticeboard.css">
		<!--[if IE]>
			<link rel="stylesheet" type="text/css" href="css/lit9013/pbf_site_ie.css">
			<link rel="stylesheet" type="text/css" href="css/lit9013/pbf_multimenuvert_ie.css">
		<![endif]-->
		<script type="text/javascript" src="js/multimenu.js"></script>
		<script type="text/javascript" src="js/tiny_mce/tiny_mce.js"></script>
		<script type="text/javascript" src="js/ajax.js"></script>
		<link rel="stylesheet" type="text/css" href="css/lit9013/pbf_content.css">
		<?php
			$oNews->include_css();
			//Istazio oggetto PG
			$oPg = new cPg;
	...
	<body id="body">
		<div id="contenitore">
			<div id="head">
				<span id="id_username_area">
					<?php
					echo " " . $oUt->dati["Name"];
					?>
				</span>
                <p id="head_message">
                <!--<span id="head_message_body"></span>-->
                </p>
			</div>
			<div id="top">
			...
			<div id="top_bottom">
				...
				if ($_SESSION["ID"]==""){
					...
					<a href="javascript:void(0);" OnClick="javascript: $('id_user_online').style.left=Event.pointerX(event)-210;$('id_user_online').style.top=Event.pointerY(event)-155;$('id_user_online').toggle();">.: OnLine(<span id="id_num_online"><?php echo $oUt->num_users_online() ?></span>) :.</a>
					<?php
				}else{
					?>
					<a style="text-align:center;" href="index.php?IdP=108"> .: FORUM :.</a>					
					<a style="margin-right:80px;" class="LinkBanner" href="<?php echo $_SERVER["DOMAIN"]; ?>src/logout.php">.: Logout :.</a>
					<?php					
					echo " " . $oUt->show_list_pg() . " ";
					if(($oUt->is_group("master") or $oUt->is_group("admins"))){
						?>
						<a style="margin-left:35px;" class="LinkBanner" OnClick="javascript: $('id_master_menu').style.left=Event.pointerX(event);$('id_master_menu').style.top=Event.pointerY(event);$('id_master_menu').toggle();">.: Master :.</a>
			...
			<div id="left">
				<div id="IdPrincipale">
					<?php
						//<ul class='menu3'>						
						$oMenu->ShowPreview($_SERVER["SITO"],118);
						//</ul>
					?>
				</div>
			</div>
