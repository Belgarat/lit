...
require_once("./associazione_inclusions.php");
...
<HTML>
	<HEAD>
		...
		<link rel="stylesheet" type="text/css" href="<?php echo HTTP_ROOT ?>/css/associazione_amb.css">
		<link rel="stylesheet" type="text/css" href="<?php echo HTTP_ROOT ?>/css/associazione_style.css">
		<link rel="stylesheet" type="text/css" href="<?php echo HTTP_ROOT ?>/css/associazione_site.css">
		<link rel="stylesheet" type="text/css" href="<?php echo HTTP_ROOT ?>/css/associazione_multimenuvert.css">
		<!--[if IE]>
			<link rel="stylesheet" type="text/css" href="<?php echo HTTP_ROOT ?>/css/associazione_site_ie.css">
			<link rel="stylesheet" type="text/css" href="<?php echo HTTP_ROOT ?>/css/associazione_multimenuvert_ie.css">
		<![endif]-->
		<script type="text/javascript" src="<?php echo HTTP_ROOT ?>/js/multimenu.js"></script>
		<script type="text/javascript" src="<?php echo HTTP_ROOT ?>/js/tiny_mce/tiny_mce.js"></script>
		<script type="text/javascript" src="<?php echo HTTP_ROOT ?>/js/ajax.js"></script>
		<link rel="stylesheet" type="text/css" href="<?php echo HTTP_ROOT ?>/css/associazione_content.css">
		<?php
			$oNews->include_css();
		?>
	...
	<body id="body">
		<div id="contenitore">
			<div id="head">
							<a title="Rss/Feed LiT news" style="display:block;z-index:10;position:absolute;left:880px;top:-10px;" href="feed/public/allnews.rss"><img src="img/associazione/ico/rss32.png"></a>
			</div>
			...
			<div id="left">
				...
				<div id="right">
					...
					<?php
					$oNews->id_tipo=1;
					$oNews->show_news($oUt->fArrayPermission($_SERVER["SITO"],"cNews"));
					//fNews($_SERVER["SITO"]);
					?>
					</div>
				</div>
