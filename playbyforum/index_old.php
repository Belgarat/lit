		...
		<div id="contenitore">
			...
			<div id="top" style="color:#b95033;">
				<div style="float:left;">
					...
					<a href="javascript:void(0);" OnClick="javascript:  var udiv = new Ajax.Updater('id_PluginBoard', 'src/ajax/utente_users_online_list.php');$('id_PluginBoard').style.left=0;$('id_PluginBoard').style.top=30-positionedOffset(this).left;$('id_PluginBoard').toggle();"> .: OnLine(<span id="id_num_online"><?php echo $oUt->num_users_online() ?></span>) :.</a>
				</div>
				<div>
				<?php
					//$oPage->show_online();
